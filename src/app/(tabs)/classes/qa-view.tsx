  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      try {
        ...
        const fileRef = storageRef(storage, `qa_uploads/${uid}/${classId}/${activityId}/${fileName}`);
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.viewerContainer}>
            {isImage && fileUrl ? (
              ...
              <View style={styles.filePlaceholder}>
                <View style={[styles.iconCircle, { backgroundColor: headerColor + '10' }]}>
        ...
        <View style={styles.hintBox}>
          ...
          <Text style={styles.hintText}>
            This file is used by the AI to verify correct answers during automated grading.
          </Text>
        </View>
      </ScrollView>
        ...
        <View style={styles.modalOverlay}>
          ...
          <View style={styles.modalCard}>
            ...
            <Text style={styles.modalSub}>
              Are you sure you want to remove this answer key? This cannot be undone.
            </Text>
...
const styles = StyleSheet.create({
  ...
  content: { padding: 20 },
  previewCard: { backgroundColor: '#fff', borderRadius: 28, padding: 20, elevation: 1, shadowColor: '#000', shadowOpacity: 0.03, shadowRadius: 15 },
  cardInfo: { marginBottom: 20, alignItems: 'center' },
  activityName: { fontSize: 12, fontWeight: '800', color: '#bbb', textTransform: 'uppercase', marginBottom: 5 },
  fileName: { fontSize: 18, fontWeight: '700', color: '#111', textAlign: 'center' },

  viewerContainer: { height: 350, backgroundColor: '#f9f9f9', borderRadius: 20, overflow: 'hidden', marginBottom: 20, justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#f0f0f0' },
