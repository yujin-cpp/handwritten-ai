      ...
      >
        ...
        <View style={styles.card}>
          ...
          <View style={styles.inputGroup}>
            ...
            >
              <Text
                style={{ color: year ? "#333" : "#999", fontWeight: "500" }}
              >
                {year}
              </Text>
              <Feather
                  ...
                  >
                    <Text
                      style={[
                        ...
                        year === y && { color: "#00b679", fontWeight: "700" },
                      ]}
                    >
                      {y}
                    </Text>
                    {year === y && (
                      <Feather name="check" size={16} color="#00b679" />
                    )}
                  </TouchableOpacity>
                ))}
              </View>
        ...
        <TouchableOpacity
          style={[
            styles.createBtn,
            (loading || !isVerified) && { opacity: 0.7 },
          ]}
          onPress={onCreate}
