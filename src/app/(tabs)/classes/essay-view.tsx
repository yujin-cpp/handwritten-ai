...
const styles = StyleSheet.create({
  ...
  modalCard: { backgroundColor: "rgba(255, 255, 255, 0.85)", borderRadius: 28, padding: 30, alignItems: 'center', shadowColor: "#000", shadowOpacity: 0.15, shadowRadius: 30, elevation: 20 },
