        ...
        {uploading ? (
          ...
          <PageMotion delay={50}>
            <TouchableOpacity onPress={() => setModalVisible(true)}>
              <GlassCard color="rgba(255,255,255,0.5)" borderRadius={32}>
                <View style={{ alignItems: 'center', paddingVertical: 60, borderWidth: 1, borderColor: 'rgba(0,0,0,0.05)', borderStyle: 'dashed', borderRadius: 32 }}>
...
const styles = StyleSheet.create({
  ...
  listLabel: { fontSize: 12, fontWeight: '800', color: '#667085', letterSpacing: 1 },
  ...
  fileDate: { fontSize: 13, color: '#475467', fontWeight: '500' },
  ...
  loadingSub: { fontSize: 13, color: '#475467', marginTop: 6 },
  ...
  uploadMainSub: { fontSize: 14, color: '#475467', marginTop: 8, textAlign: 'center', paddingHorizontal: 40 },

  modalOverlay: { flex: 1, backgroundColor: "rgba(0,0,0,0.38)", justifyContent: "center", padding: 25 },
  modalCard: { backgroundColor: "rgba(255, 255, 255, 0.95)", borderRadius: 28, padding: 24, shadowColor: "#000", shadowOpacity: 0.14, shadowRadius: 24, elevation: 12 },
  ...
  modalHelp: { textAlign: 'center', fontSize: 12, color: '#475467', marginTop: 20, fontStyle: 'italic' },
});
