...
const firebaseConfig = {
    ...
    databaseURL: "https://handwritten-ai-system-default-rtdb.firebaseio.com"
};
...
async function testFetch() {
    ...
    const activitiesRef = ref(db, `professors/${profId}/classes/${classId}/activities`);
    ...
    const studentsRef = ref(db, `professors/${profId}/classes/${classId}/students`);
